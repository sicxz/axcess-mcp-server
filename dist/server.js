...
Returns: JSON with tool descriptions, pricing, and rubric categories.`,
        ...
        const capabilities = {
            ...
            description: 'Evaluates design work against an expert-crafted accessibility rubric that goes beyond WCAG technical compliance. Catches issues automated scanners miss because they require design judgment.',
            tools: [
                {
                    name: 'evaluate_typography',
                    price: PRICING_INFO.evaluate_typography,
                    description: 'Evaluates typography elements for accessibility issues beyond WCAG minimums. Checks contrast with font-weight context, minimum sizes, line height, line length, all-caps, extended italic, letter spacing, text on non-solid backgrounds, and heading hierarchy.',
                ...
                },
                {
                    ...
                    description: 'Full accessibility evaluation combining typography, color, and interaction checks. Produces an overall compliance score and prioritized issue list.',
                    status: 'coming_soon',
                },
            ],
            rubric_categories: [
            ...
            what_makes_this_different: 'Automated scanners (axe, Lighthouse, WAVE) catch ~30% of WCAG failures. They fail on design-time files (Figma), cannot evaluate perceived legibility vs. numeric compliance, and have no concept of design principles. This rubric was built by a visual communication design educator with 18 years of critique experience.',
            payment: {
                protocol: 'x402',
                network: 'Base Sepolia by default; configurable via X402_NETWORK/X402_FACILITATOR_URL',
                token: 'USDC',
                instructions: 'Read the PAYMENT-REQUIRED header from the 402 response, create a payment payload, then retry with PAYMENT-SIGNATURE.',
            },
        };
        return {
    ...
    server.registerTool('evaluate_typography', {
